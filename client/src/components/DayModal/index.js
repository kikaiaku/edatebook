...
import { Modal, Form, Button, ModalDialog } from 'react-bootstrap';
...
function DayModal(props) {
    ...
    return (
        <Draggable handle='.modal-header' bounds='.modal-content'>
            <Modal 
                show={props.showDayModal} backdrop="static" onHide={() => props.setShowDayModal(false)}>
                    <span>
                <Modal.Header
                    closeButton>
                    <Modal.Title
